...
/**
 * Converts inventory-service exceptions into stable API error responses.
 */
...
public class InventoryExceptionHandler {
     ...
     *
     * @param ex inventory-item-not-found exception
     * @param request current HTTP request
     * @return standardized API error response
     */
    @ExceptionHandler(InventoryItemNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ApiError handleInventoryItemNotFound(InventoryItemNotFoundException ex, HttpServletRequest request) {
        return ApiError.of("INVENTORY_ITEM_NOT_FOUND", ex.getMessage(), request.getRequestURI());
    }

    /**
     * Handles missing inventory reservation results.
     *
     * @param ex inventory-reservation-not-found exception
     * @param request current HTTP request
     * @return standardized API error response
     */
    @ExceptionHandler(InventoryReservationNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ApiError handleInventoryReservationNotFound(
            InventoryReservationNotFoundException ex,
            HttpServletRequest request
    ) {
        return ApiError.of("INVENTORY_RESERVATION_NOT_FOUND", ex.getMessage(), request.getRequestURI());
    }
