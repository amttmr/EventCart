...
/**
 * Explicit Kafka producer infrastructure for order-service.
 *
 * <p>The service depends on Spring Kafka directly, so this configuration
 * creates the producer factory, template, and admin client used for topic
 * creation instead of relying on framework auto-configuration.</p>
 */
@Configuration
